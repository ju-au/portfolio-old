      ...
      <div class="container">
        ...
        <div class="works-contents">
          <div class="works-item">
            <img class="works-img works-img-left" src="./photos/portfolio.png" alt="このポートフォリオサイトのスクリーンショット">
          ...
          <div class="works-item">
            <img class="works-img works-img-right" src="./photos/airbnbcopy.png" alt="Airbnb模写のスクリーンショット">
          ...
          <div class="works-item">
            <img class="works-img works-img-right" src="./photos/portfolio2.png" alt="架空ECサイトのスクリーンショット">
            <div class="works-text works-text-right">
              <h3>架空ECサイト</h3>
              <span>詳細は画像をタップ</span>
              <h4>使用言語</h4>
              <p>WordPress<br>Woo Commerce (プラグイン)<br>Contact Form 7 (プラグイン)</p>
              <a href="http://localhost/wp-portfolio-ecommerce">こちらをクリックするとサイトに移動します</a>
            </div>
          </div>
        </div>
      </div>
